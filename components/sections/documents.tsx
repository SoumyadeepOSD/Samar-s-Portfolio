...
import { aadhaarImage, drivingImage, panImage, rationcardImage, vaccinationImage, vehicleDocImages, voterImage } from '../images'
...
const Documents = () => {
  return (
    <div>
        ...
        <DropDownItem imageUrl={vehicleDocImages} qualification={"Vehicle Information"} institution={""} />
        </div>
    </div>
  )
}
